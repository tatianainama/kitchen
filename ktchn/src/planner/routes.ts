...
import { savePlan, saveWeekPlanner, validatePlanner, validateRange, getPlannerByRange, getSimplifyPlannerByRange } from './controller';
...
class PlannerRoutes {
  ...
  private init() {
    ...
    this.router.get('/week/simplify/:from/:to', chainP([validateRange(this.PlannerDB), getSimplifyPlannerByRange(this.PlannerDB)]))

...
export const Recipe: FC<RecipeProps> = (recipe) => <Layout className="md:py-8">
  <div className="layout-container">
    <header className="relative flex flex-col md:flex-row md:border-2">
      <div style={{ backgroundImage: `url(${recipe.image})` }} className="h-48 w-full bg-cover bg-center sm:h-96 sm:border-b-2 md:border-r-2 md:border-b-0 md:h-auto md:min-h-[18rem] md:w-5/12">
      </div>

  ...
  <Layout className="md:py-8">
    <div className="layout-container md:w-with-padding">
      <header className="relative flex flex-col md:flex-row md:border-2">
        ...
        ></div>
        <div className="relative py-6 px-4 border-t-2 bg-white sm:-mt-14 sm:w-with-padding sm:border-2 sm:mx-auto md:mt-0 md:border-none md:w-8/12 md:p-6">
          <h1>{recipe.name}</h1>
          {recipe.tags.length ? (
      ...
      <div className="bg-white border-t-2 sm:w-with-padding sm:mx-auto sm:border-2 sm:border-t-0 md:w-full md:flex">
        <section className="py-6 px-4 md:p-6 md:w-4/12">
          <h2>Ingredients</h2>
          <IngredientList recipe={recipe} />
        </section>
        <section className="py-6 px-4 md:p-6 md:w-8/12">
          <h2>Instructions</h2>
